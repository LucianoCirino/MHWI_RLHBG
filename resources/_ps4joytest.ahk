...
Loop
{
	...
	Loop, %joy_buttons%
	{
		...
		if joy%A_Index% = D
			buttons_down = %buttons_down%%A_Space% Joy%A_Index%
	}
/*
...
*/
	ToolTip, %joy_name% (#%JoystickNumber%):`n%axis_info%`nButtons Down: %buttons_down%`n`n(press the SPACE bar to end test)
	Sleep, 100
}
return
Space::ExitApp 